...
# v17, the narrowly scoped v18 consumed-history rehabilitation, and v20 remain
# historical identities.  v21 is the current ordinary three-horizon recipe
# and binds the governed factor/model signal hand-off into strategy research.
