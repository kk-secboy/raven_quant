        ...
        with nullcontext(temporary_manager.name) as temporary:
            ...
            source.run(
                ...
                (
                    ...
                    "daily_dataset, daily_dataset_identity_sha256, "
                    "daily_dataset_lineage_id, execution_dataset, "
                    "execution_dataset_identity_sha256, execution_dataset_lineage_id, "
                    ...
                    f"'pair', '{sentinel}{sentinel}', "
                    f"'restore-daily', '{sentinel}{sentinel}', '{sentinel}{sentinel}', "
                    f"'restore-minute', '{sentinel}{sentinel}', '{sentinel}{sentinel}', "
                    f"'{sentinel}{sentinel}', current_date - 1, current_date, "
