...
当前受管策略运行时为 `qlib-rdagent-single-mainline-2026-09-07-v40`。新增研究活动入口
...
迁移 `0111_autopilot_research_events` 增加活动身份，`0112_strategy_runtime_v40` 封存新闭包；
v39 及更早的身份、结果、迁移和 OOS 消费记录保持原样。
