...
strategy_versions = Table(
    ...
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-04-v29' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
        ...
        "'target_worker_runtime_image_digest' ~ '^sha256:[0-9a-f]{64}$'"
        ") ELSE true END) IS TRUE",
        name="ck_strategy_versions_v29_runtime_identity",
    ),
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-04-v30' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
        ...
        "'target_worker_runtime_image_digest' ~ '^sha256:[0-9a-f]{64}$'"
        ") ELSE true END) IS TRUE",
        name="ck_strategy_versions_v30_runtime_identity",
    ),
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-04-v31' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
        ...
        "'target_worker_runtime_image_digest' ~ '^sha256:[0-9a-f]{64}$'"
        ") ELSE true END) IS TRUE",
        name="ck_strategy_versions_v31_runtime_identity",
    ),
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-04-v32' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
        ...
        "'target_worker_runtime_image_digest' ~ '^sha256:[0-9a-f]{64}$'"
        ") ELSE true END) IS TRUE",
        name="ck_strategy_versions_v32_runtime_identity",
    ),
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-04-v33' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
        ...
        "'target_worker_runtime_image_digest' ~ '^sha256:[0-9a-f]{64}$'"
        ") ELSE true END) IS TRUE",
        name="ck_strategy_versions_v33_runtime_identity",
    ),
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-05-v34' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
    ...
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-06-v36' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
        ...
        "'target_worker_runtime_image_digest' ~ '^sha256:[0-9a-f]{64}$'"
        ") ELSE true END) IS TRUE",
        name="ck_strategy_versions_v36_runtime_identity",
    ),
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-06-v37' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
        ...
        "'target_worker_runtime_image_digest' ~ '^sha256:[0-9a-f]{64}$'"
        ") ELSE true END) IS TRUE",
        name="ck_strategy_versions_v37_runtime_identity",
    ),
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-06-v38' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
        ...
        "'target_worker_runtime_image_digest' ~ '^sha256:[0-9a-f]{64}$'"
        ") ELSE true END) IS TRUE",
        name="ck_strategy_versions_v38_runtime_identity",
    ),
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-06-v39' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
    ...
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-07-v41' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
        ...
        "'target_worker_runtime_image_digest' ~ '^sha256:[0-9a-f]{64}$'"
        ") ELSE true END) IS TRUE",
        name="ck_strategy_versions_v41_runtime_identity",
    ),
    # The v42 source identity is independent of the immutable v41 constraint above.
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-07-v42' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
    ...
    # The v44 source identity is independent of the immutable v43 constraint above.
    CheckConstraint(
        "(CASE WHEN "
        "COALESCE(config_json ->> 'recipe_version', '') = "
        "'qlib-rdagent-single-mainline-2026-09-14-v44' THEN ("
        "COALESCE(config_json ->> 'recipe_id', '') IN "
        "('short_relative_strength','swing_trend','long_quality_value') "
        "AND evidence_mode = 'sealed_final_oos' "
        "AND config_json -> 'transparent_baseline_bootstrap' ->> "
        ...
        "'target_worker_runtime_image_digest' ~ '^sha256:[0-9a-f]{64}$'"
        ") ELSE true END) IS TRUE",
        name="ck_strategy_versions_v44_runtime_identity",
    ),
)
Index(
