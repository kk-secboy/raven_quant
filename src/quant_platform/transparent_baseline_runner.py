...
STRATEGY_RESEARCH_V31_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-04-v31"
)
STRATEGY_RESEARCH_V31_TARGET_RUNNER_SHA256 = (
    "036d7979581b3de719532303435f8fba81e43f4403b3c82bf371e5c18820b7f2"
)
# Historical v31 seal. It remains independently addressable after v32 becomes
# current so already-applied database constraints and evidence stay immutable.
STRATEGY_RESEARCH_V31_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "dac80be45fcae33d2bcdafff76aa2b71feac6624deb25b542bfc02961584f1b8"
)
STRATEGY_RESEARCH_V32_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-04-v32"
)
STRATEGY_RESEARCH_V32_TARGET_RUNNER_SHA256 = (
    "aa6a106935705f341608922f3ba7ef8cb7d8333412b19203917cf2b28613c9e8"
)
# Historical v32 seal. It remains independently addressable after v33 becomes
# current so already-applied database constraints and evidence stay immutable.
STRATEGY_RESEARCH_V32_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "4e35515b1778b7c6e85cd99211581102f17873f6d59f4a710ed6bc603c945630"
)
STRATEGY_RESEARCH_V33_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-04-v33"
)
STRATEGY_RESEARCH_V33_TARGET_RUNNER_SHA256 = (
    "aa6a106935705f341608922f3ba7ef8cb7d8333412b19203917cf2b28613c9e8"
)
# Historical v33 identity remains immutable when v34 becomes current.
STRATEGY_RESEARCH_V33_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "f7e6511f0b8391b89713e483a1d01600033f984109af2961a902d23cc4437183"
)
STRATEGY_RESEARCH_V34_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-05-v34"
)
STRATEGY_RESEARCH_V34_TARGET_RUNNER_SHA256 = (
    "6df09f5bac9d8e10292a850da64707a1509d4896c4d65febd70aa3287413adf8"
)
# Historical v34 identity remains immutable when v35 becomes current.
STRATEGY_RESEARCH_V34_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "6ea1c1e35b84923493f1f1b803189839296bf3c31f05d71ea915dba2f19450a4"
)
STRATEGY_RESEARCH_V35_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-05-v35"
)
STRATEGY_RESEARCH_V35_TARGET_RUNNER_SHA256 = (
    "6df09f5bac9d8e10292a850da64707a1509d4896c4d65febd70aa3287413adf8"
)
# Historical v35 identity remains immutable when v36 becomes current.
STRATEGY_RESEARCH_V35_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "c55ef3e92a8ef1390983399c114c5bf571711f3f2583185e7ed805854e4a72e4"
)
STRATEGY_RESEARCH_V36_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-06-v36"
)
STRATEGY_RESEARCH_V36_TARGET_RUNNER_SHA256 = (
    "372d8744947144be822aeda155fa2907b6aefda464422b759d1083b772148054"
)
# Historical v36 identity remains immutable when v37 becomes current.
STRATEGY_RESEARCH_V36_TARGET_RUNTIME_BUNDLE_SHA256 = (
...
STRATEGY_RESEARCH_V37_TARGET_RUNNER_SHA256 = (
    "372d8744947144be822aeda155fa2907b6aefda464422b759d1083b772148054"
)
# Historical v37 identity remains immutable when v38 becomes current.
STRATEGY_RESEARCH_V37_TARGET_RUNTIME_BUNDLE_SHA256 = (
...
STRATEGY_RESEARCH_V38_TARGET_RUNNER_SHA256 = (
    "4a94328bf92b822da69530ffccccf0067cc3d2727d512d8d54f51095ef422717"
)
# Historical v38 identity remains immutable when v39 becomes current.
STRATEGY_RESEARCH_V38_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "9f78afdd7ee5e5688b595d327091ee541608a7220b7cf75c6600350673dc3e41"
)
STRATEGY_RESEARCH_V39_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-06-v39"
)
STRATEGY_RESEARCH_V39_TARGET_RUNNER_SHA256 = (
    "4a94328bf92b822da69530ffccccf0067cc3d2727d512d8d54f51095ef422717"
)
# Historical v39 identity remains immutable when v40 becomes current.
STRATEGY_RESEARCH_V39_TARGET_RUNTIME_BUNDLE_SHA256 = (
...
STRATEGY_RESEARCH_V40_TARGET_RUNNER_SHA256 = (
    "4a94328bf92b822da69530ffccccf0067cc3d2727d512d8d54f51095ef422717"
)
STRATEGY_RESEARCH_V40_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "082416817e984f1956186a13b8f76864d4142267d9e1b297e00a1ebdfc4c94a1"
)
# Historical v41 identity is immutable across the prepared-data release.
STRATEGY_RESEARCH_V41_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-07-v41"
)
STRATEGY_RESEARCH_V41_TARGET_RUNNER_SHA256 = (
    "bc0cfad1188eb3103295f33f959e3d4bfed5f8b17527610873796d0c4cacaf4c"
)
STRATEGY_RESEARCH_V41_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "7d6b07b833e71f9309ac0211c084b49a3fbbe0c93b6611e4c426016bd930b5f6"
)
STRATEGY_RESEARCH_V42_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-07-v42"
)
STRATEGY_RESEARCH_V42_TARGET_RUNNER_SHA256 = (
    "bc0cfad1188eb3103295f33f959e3d4bfed5f8b17527610873796d0c4cacaf4c"
)
# Sealed against the complete v42 source closure. The source-closure
# normalizer excludes only the seal values from their own digest.
STRATEGY_RESEARCH_V42_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "6375f33d9a3dff138be9815f0fefc15ec7f21ae64cd303e0b682d265e5835dbf"
)
STRATEGY_RESEARCH_V43_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-08-v43"
)
STRATEGY_RESEARCH_V43_TARGET_RUNNER_SHA256 = (
    "bc0cfad1188eb3103295f33f959e3d4bfed5f8b17527610873796d0c4cacaf4c"
)
# Sealed against the complete v43 source closure. The source-closure
# normalizer excludes only the seal values from their own digest.
STRATEGY_RESEARCH_V43_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "6dc7f9cabe2c5e1850d8f1b7b51e9c4ce87d9d2b93947c7f8d4c3253287a483e"
)
STRATEGY_RESEARCH_TARGET_RECIPE_VERSION = (
    "qlib-rdagent-single-mainline-2026-09-14-v44"
)
STRATEGY_RESEARCH_TARGET_RUNNER_SHA256 = (
    "bc0cfad1188eb3103295f33f959e3d4bfed5f8b17527610873796d0c4cacaf4c"
)
# Sealed against the complete v44 source closure. The source-closure
# normalizer excludes only the seal values from their own digest.
STRATEGY_RESEARCH_TARGET_RUNTIME_BUNDLE_SHA256 = (
    "905a5d9b7473bf9c0ef023be4296edd8cf88e87d90c2d1c4f7383707db5149b4"
)
...
_TARGET_RUNNERS = {
    ...
    STRATEGY_RESEARCH_V40_TARGET_RECIPE_VERSION: STRATEGY_RESEARCH_V40_TARGET_RUNNER_SHA256,
    STRATEGY_RESEARCH_V41_TARGET_RECIPE_VERSION: STRATEGY_RESEARCH_V41_TARGET_RUNNER_SHA256,
    STRATEGY_RESEARCH_V42_TARGET_RECIPE_VERSION: STRATEGY_RESEARCH_V42_TARGET_RUNNER_SHA256,
    STRATEGY_RESEARCH_V43_TARGET_RECIPE_VERSION: STRATEGY_RESEARCH_V43_TARGET_RUNNER_SHA256,
...
def target_runtime_bundle_for_recipe(recipe_id: Any, recipe_version: Any) -> str | None:
    ...
    if normalized_recipe_version == STRATEGY_RESEARCH_V31_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V31_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V32_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V32_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V33_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V33_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V34_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V34_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V35_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V35_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V36_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V36_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V37_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V37_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V38_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V38_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V39_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V39_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V40_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V40_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V41_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V41_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V42_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V42_TARGET_RUNTIME_BUNDLE_SHA256
    if normalized_recipe_version == STRATEGY_RESEARCH_V43_TARGET_RECIPE_VERSION:
        return STRATEGY_RESEARCH_V43_TARGET_RUNTIME_BUNDLE_SHA256
...
def target_worker_runtime_image_for_recipe(
    ...
    version_label = {
        ...
        STRATEGY_RESEARCH_V31_TARGET_RECIPE_VERSION: "v31",
        STRATEGY_RESEARCH_V32_TARGET_RECIPE_VERSION: "v32",
        STRATEGY_RESEARCH_V33_TARGET_RECIPE_VERSION: "v33",
        STRATEGY_RESEARCH_V34_TARGET_RECIPE_VERSION: "v34",
        STRATEGY_RESEARCH_V35_TARGET_RECIPE_VERSION: "v35",
        STRATEGY_RESEARCH_V36_TARGET_RECIPE_VERSION: "v36",
        STRATEGY_RESEARCH_V37_TARGET_RECIPE_VERSION: "v37",
        STRATEGY_RESEARCH_V38_TARGET_RECIPE_VERSION: "v38",
        STRATEGY_RESEARCH_V39_TARGET_RECIPE_VERSION: "v39",
        STRATEGY_RESEARCH_V40_TARGET_RECIPE_VERSION: "v40",
        STRATEGY_RESEARCH_V41_TARGET_RECIPE_VERSION: "v41",
        STRATEGY_RESEARCH_V42_TARGET_RECIPE_VERSION: "v42",
        STRATEGY_RESEARCH_V43_TARGET_RECIPE_VERSION: "v43",
        STRATEGY_RESEARCH_TARGET_RECIPE_VERSION: "v44",
    }[normalized_recipe_version]
    ...
    *,
    ...
    if version_label in {
        ...
        expected_bundle_sha256 = {
            ...
            "v31": STRATEGY_RESEARCH_V31_TARGET_RUNTIME_BUNDLE_SHA256,
            "v32": STRATEGY_RESEARCH_V32_TARGET_RUNTIME_BUNDLE_SHA256,
            "v33": STRATEGY_RESEARCH_V33_TARGET_RUNTIME_BUNDLE_SHA256,
            "v34": STRATEGY_RESEARCH_V34_TARGET_RUNTIME_BUNDLE_SHA256,
            "v35": STRATEGY_RESEARCH_V35_TARGET_RUNTIME_BUNDLE_SHA256,
            "v36": STRATEGY_RESEARCH_V36_TARGET_RUNTIME_BUNDLE_SHA256,
            "v37": STRATEGY_RESEARCH_V37_TARGET_RUNTIME_BUNDLE_SHA256,
            "v38": STRATEGY_RESEARCH_V38_TARGET_RUNTIME_BUNDLE_SHA256,
            "v39": STRATEGY_RESEARCH_V39_TARGET_RUNTIME_BUNDLE_SHA256,
            "v40": STRATEGY_RESEARCH_V40_TARGET_RUNTIME_BUNDLE_SHA256,
            "v41": STRATEGY_RESEARCH_V41_TARGET_RUNTIME_BUNDLE_SHA256,
            "v42": STRATEGY_RESEARCH_V42_TARGET_RUNTIME_BUNDLE_SHA256,
            "v43": STRATEGY_RESEARCH_V43_TARGET_RUNTIME_BUNDLE_SHA256,
            "v44": STRATEGY_RESEARCH_TARGET_RUNTIME_BUNDLE_SHA256,
        }[version_label]
